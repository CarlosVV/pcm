...
namespace ProjectContentManager.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            {
                Roles = (new ApplicationDbContext()).Roles.OrderBy(r => r.Name).ToList().Select(rr =>
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, BirthDate = model.BirthDate, 
                    FirstName = model.FirstName, FirstLastName = model.FirstLastName, SecondLastName = model.SecondLastName, 
